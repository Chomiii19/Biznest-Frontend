      ...
      <View className="flex-1 bg-backgroundColor">
        ...
        <View className="p-4 flex-col w-full gap-5">
          ...
          <View className="w-full flex-col">
            ...
            <TextInput
              placeholder="E.g. Account issue, Business Inquiry, Request"
          ...
          <View className="w-full items-center justify-center flex-col">
            <TouchableOpacity
              ...
              className={`w-full rounded-xl justify-between items-center py-3 ${subject && description ? "bg-primary" : "bg-zinc-700"}`}
            >
              <Text
            ...
            <Text className="text-xs text-zinc-600 font-rRegular mt-2">
              Responses will be sent via user email.
            </Text>
          </View>
        </View>
      </View>
